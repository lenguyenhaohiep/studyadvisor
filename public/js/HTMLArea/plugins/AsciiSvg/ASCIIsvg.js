...
Ver 1.2.7 Jan 13, 2006 (c) Peter Jipsen http://www.chapman.edu/~jipsen
...
//xscl=x is equivalent to xtick=x; xgrid=x; labels=true;
  ...
  if (dx <= 0) throw "xscl, xtick, dx must be positive";
  dy = (dy==null?dx:dy*yunitlength);
  if (dy <= 0) throw "yscl, ytick, dy must be positive";
