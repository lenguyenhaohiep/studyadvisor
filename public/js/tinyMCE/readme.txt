...
(c) 2008-2009 David Lippman.   http://www.pierce.ctc.edu/dlippman/
			       http://www.imathas.com

ver 0.20  9/15/09: Updaded to work with TinyMCE 3.2.5
...
<script type="text/javascript" src="jscript/plugins/asciisvg/js/ASCIIsvgPI.js"></script>
...
do not display correctly without the necessary fonts.

The SVG sniffer included in the version of ASCIIsvgPI.js included in this
distribution is enabled for IE+AdobeSVGviewer, Mozilla 1.8+ (Firefox 2+), 
Opera 9, and Webkit (Safari 3, Chrome).  The SVG implementation in Opera and
Webkit are a bit iffy - if you have trouble, you can diable them by removing
the appropriate block of the isSVGavailable function.
