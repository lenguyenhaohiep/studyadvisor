...
class Zend_View_Helper_ViewQuestionTestOne {
	/*
	 ...
	 */
	function viewQuestionTestOne($test_id=null, $question_id, $title_question="",$answer_of_user = array(),$review_test=0,$view_corect=0,$view_feedback=0,$view_send_result=0,$view_score=-1, $score_of_question=null,$classEatScore="") {
				...
				case 5: // essay
					...
					$html .='<li><b>'.$question_content.'</b></li>';
						...
						foreach ($answer_of_user as $answer_of_userItem){
								$html .='<li>';
								//$html .='<textarea  id="short-editor-essay-testone" rows="5" cols="100"  name="question['.$question_id.'][]"  class="'.$class.'  class-input-question-'.$question_id.'" >'.$answer_of_userItem.'</textarea>';
								//-'.$question_id.'
								$html .='<textarea  id="short-editor-essay-testone" rows="5" cols="100"  name="question['.$question_id.'][]"  class="short-editor-essay-testone  class-input-question-'.$question_id.'" >'.$answer_of_userItem.'</textarea>';
