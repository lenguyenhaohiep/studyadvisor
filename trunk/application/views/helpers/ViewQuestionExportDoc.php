...
class Zend_View_Helper_ViewQuestionExportDoc {
	/*
	 ...
	 */
	function viewQuestionExportDoc($test_id=null, $question_id, $title_question="",$answer_of_user = array(),$review_test=0,$view_corect=0,$view_feedback=0,$view_send_result=0,$view_score=-1, $score_of_question=null,$classEatScore="") {
