...
class Zend_View_Helper_ViewQuestionExportDocFixBugThuc {
	/*
	 ...
	 */
	function viewQuestionExportDocFixBugThuc($test_id=null, $question_id, $title_question="",$answer_of_user = array(),$review_test=0,$view_corect=0,$view_feedback=0,$view_send_result=0,$view_score=-1, $score_of_question=null,$classEatScore="") {
 ...
 *--------------------------------------------------------------------------------------------------------------------*/				
				case 1: // true false
					...
					$html .='<h4 id="question-title-'.$question_id.'">'.$title_question.'  '.$question_content.'</h4>';
							...
							foreach ($allAnswers as $key=>$allAnswersItem){								
								...
								if($resultAns==1){// nếu có ID 
									...
									if(!$check)
										$li_css  = '';
									//$html .='<li>';
										$html .='<table style="width:800px; text-align: left;">';
											$html.='<tr>';
												$html.='<td style="text-align: left;">';		
													$html.='<table>';
													$html.='<tr>';												
														$html.='<td style="width:30px;">';
															//$html .='<p><input type="'.$typeInput.'"  name="question['.$question_id.'][]"  class="class-input-question-'.$question_id.'" value="'.$ans_id.'" '.$readonly.$check.' /></p>';
 ...
 *--------------------------------------------------------------------------------------------------------------------*/				
				...
				case 2: // multi choice					
					...
					$html .='<div id="question-'.$question_id.'" class="question-container-div" >';
					//$html .='<h4 id="question-title-'.$question_id.'">'.$title_question.'</h4>';
					$html .='<h4 id="question-title-'.$question_id.'">'.$title_question.'  '.$question_content.'</h4>';
					//$html .='<ul style="list-style: none;">';
					$html .='<span>';
						$html_correct = '';						
				...
				case 3: // matching
					...
					if(count($allAnswers)){								
							...
							//$html.='<li style="list-style: none;" >';
								$html.='<table>';
									$html.='<tr>';
										$html.='<th><font size="3">A</font></th>';
										$html.='<th>Chọn cặp đúng</th>';
										$html.='<th><font size="3">B</font></th>';
									$html.='</tr>';
 ...
 *--------------------------------------------------------------------------------------------------------------------*/				
				...
				case 4: // completion
					...
					$html .='<div id="question-'.$question_id.'" class="question-container-div">';
					$html .='<h4 id="question-title-'.$question_id.'">'.$title_question.'  Điền vào chỗ trống :</h4>';
					//$html.='<input type="hidden" name="question_id[]" value="'.$question_id.'">';
					$html.='<table>';
						$html.='<tr>';
						$html.='<td>';
							$html.='<div id="completion-'.$question_id.'">'.$question_content.'</div>';
							$name_id_question = 'completion-'.$question_id;
						$html.='</td>';
						/*Hết phần hiển thị câu trả lời*/
						/*--------Correct-----------*/
						/*--------End Of Correct-----------*/
					...
					$html.='<script language="javascript">';
							...
							$html.='$("#'.$name_id_question.'").find("input").after("..............");';
							$html.='$("#'.$name_id_question.'").find("input").remove();';
					$html.='</script>';
					break;
				...
				case 5: // essay
					...
					//$html .='<li><b>'.$question_content.'</b></li>';
						...
						foreach ($answer_of_user as $answer_of_userItem){
								$html .='<li>';
								$html .='<textarea  class="'.$class.'" rows="5" cols="20"  name="question['.$question_id.'][]"  class="class-input-question-'.$question_id.'" />'.$answer_of_userItem.'</textarea>';
								$html .='</li>';													
						}
						else{
								$html .='<li>';
								$html .='<textarea  class="'.$class.'" rows="5" cols="20"  name="question['.$question_id.'][]"  class="class-input-question-'.$question_id.'" /></textarea>';
								$html .='</li>';													
							...
							foreach ($allAnswers as $key=>$allAnswersItem){								
								...
								if($resultAns==1){// nếu có ID 
									...
									if($view_corect==1){
												...
												$html_correct .='<textarea  class="editor_readonly"  readonly="readonly"  rows="5" cols="20"  />'.$ans_content.'</textarea>';
										}																									
									$html .='</li>';			
								}							
							}						
 ...
 *--------------------------------------------------------------------------------------------------------------------*/				
				...
				case 6: // short answer
					...
					/*Phần hiển thị câu trả lời*/
					$html .='<div id="question-'.$question_id.'" class="question-container-div">';
					//$html .='<h4 id="question-title-'.$question_id.'">'.$title_question.'</h3>';
					$html .='<h4 id="question-title-'.$question_id.'">'.$title_question.'  '.$question_content.'</h4>';
					//$html .='<input type="hidden" name="question_id[]" value="'.$question_id.'"/>';
					$html .='<ul style="list-style: none;">';
					//$html .='<li><b>'.$question_content.'</b></li>';
