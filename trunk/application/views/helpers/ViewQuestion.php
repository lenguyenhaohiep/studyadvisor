...
class Zend_View_Helper_ViewQuestion {
	/*
	 ...
	 */
	function viewQuestion($test_id=null, $question_id, $title_question="",$answer_of_user = array(),$review_test=0,$view_corect=0,$view_feedback=0,$view_send_result=0,$view_score=-1, $score_of_question=null,$classEatScore="") {
										...
										if($i<count($ansA)){
											if($view_corect==1){
											 ...
											 for($j=0;$j<count($ansB);$j++){											 	 
											 	 ...
											 	 if(isset($answer_of_user[$i]) && ($answer_of_user[$i]==$valueOfOption))
